  ...
  return (
    <ThemeProvider attribute="class" defaultTheme="dark" enableSystem>
      <div
        ...
        sm:p-12 font-[family-name:(--font-geist-sans)] bg-background
        text-foreground"
      >
          ...
          <section className="mb-16 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              {features.map((feature, index) => (
                 <div
                   key={index}
                   className="bg-[#0a0a0a] border border-1 p-6 rounded-xl
                   transition-opacity duration-300 hover:opacity-80 hover:shadow-lg"
                  >
